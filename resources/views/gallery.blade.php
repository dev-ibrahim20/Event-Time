...
<!-- Stats Section -->
<section class="py-20 bg-gradient-to-r from-gray-900 to-gray-800 text-white" style="background: linear-gradient(135deg, #ab010f, #4c5a69, #3804c5 80%);">
    <div class="container mx-auto px-4">
...
<!-- CTA Section -->
<section class="py-20 bg-red-600 text-white" style="background: linear-gradient(135deg, #ab010f, #4c5a69, #3804c5 80%);">
