    ...
    <div class="container mx-auto px-4 text-center">
        <div class="max-w-3xl mx-auto" data-aos="fade-up">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="https://wa.me/966500000000" class="bg-green-500 text-white px-8 py-4 rounded-lg text-lg font-bold hover:bg-green-600 transition-all duration-300 transform hover:scale-105 shadow-xl" style="background: linear-gradient(135deg, #C0C0C0 0%, #808080 35%, #696969 65%, #2F4F4F 100%);">
                    <i class="fab fa-whatsapp ml-2"></i>
                    {{ app()->getLocale() == 'ar' ? 'تواصل عبر واتسآب' : 'Contact via WhatsApp' }}
                </a>
                <a href="tel:+966500000000" class="bg-green-500 text-white px-8 py-4 rounded-lg text-lg font-bold hover:bg-green-600 transition-all duration-300 transform hover:scale-105 shadow-xl" style="background: linear-gradient(135deg, #C0C0C0 0%, #808080 35%, #696969 65%, #2F4F4F 100%);">
